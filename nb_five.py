...
class NaiveBayes:
    ...
    def train_model(self, num_docs=None):
        ...
        for (p, label) in [ (early_1700_path, EARLY_1700), (late_1700_path, LATE_1700), (early_1800_path, EARLY_1800), (late_1800_path, LATE_1800), (early_1900_path, EARLY_1900) ]:
    ...
    def log_prior(self, label):
        ...
        """
        class_sums = math.log(self.class_total_doc_counts[EARLY_1700]) + math.log(self.class_total_doc_counts[LATE_1700]) + math.log(self.class_total_doc_counts[EARLY_1800]) + math.log(self.class_total_doc_counts[LATE_1800]) + math.log(self.class_total_doc_counts[EARLY_1900])
...
def evaluate_nb_model() :
    ...
    sortedArr = [(EARLY_1700, word_counts[EARLY_1700]), (LATE_1700, word_counts[LATE_1700]), (EARLY_1800, word_counts[EARLY_1800]), (LATE_1800, word_counts[LATE_1800]), (EARLY_1900, word_counts[EARLY_1900])]
    ...
    for i in range(len(freq_lists)):
        ...
        if i is 1:
            ...
            color = 'c'
        rects.append(ax.bar(X + (i * 0.20), freq_lists[i], color = color, width = 0.14)[0])
    ax.set_xticks(X + .14)
